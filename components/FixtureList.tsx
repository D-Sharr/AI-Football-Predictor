                ...
                <div className="flex items-center space-x-2 ml-4 flex-shrink-0">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M5 2a1 1 0 011 1v1.158A3.001 3.001 0 0110 4a3 3 0 014 2.842V4a1 1 0 112 0v2.842a3 3 0 01-1.158 2.22l-1.342 1.342a3 3 0 01-2.22 1.158H9.158a3 3 0 01-2.22-1.158L5.596 9.06A3 3 0 014.438 6.842V4a1 1 0 011-1zM10 6a1 1 0 100 2 1 1 0 000-2zM3 13.158V16a1 1 0 001 1h1.842a3 3 0 012.22 1.158l1.342 1.342a3 3 0 011.158 2.22v.28a1 1 0 001 1h.28a3 3 0 012.22-1.158l1.342-1.342a3 3 0 011.158-2.22H16a1 1 0 001-1v-2.842a3 3 0 01-1.158-2.22l-.16-.8a1 1 0 00-1-1H4a1 1 0 00-1 1v.8l-.16.8A3 3 0 013 13.158z" clipRule="evenodd" />
                    </svg>
                  </button>
                  <button
